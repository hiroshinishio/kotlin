...
fun case1() {
    ...
    val base1: <!REDUNDANT_EXPLICIT_TYPE!>BaseImplCase1<!> = BaseImplCase1()
}
...
fun case2() {
    ...
    val base: <!REDUNDANT_EXPLICIT_TYPE!>BaseImplCase2<!> = BaseImplCase2(1, "1", 1.2, mutableListOf({ 1 }, { 4 }, { throw Exception() }))
